...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: localePath(locale, "/shipping-policy"),
    },
  };
}
...
const GLANCE = [
  ...
  {
    value: "DDP",
    label: "DUTIES PREPAID AT CHECKOUT · INTERNATIONAL",
    tbc: false,
  },
];
...
const TRACKING_STEPS = [
  {
    ...
    body: "You'll get a confirmation email the moment your order is placed.",
  },
  {
    num: "02",
    title: "Shipment notification",
    body: "A tracking link arrives by email as soon as your order ships.",
  },
  {
    num: "03",
    title: "Track anywhere",
    body: "Follow your package from our door to yours. First scan may take up to 24 hours to appear.",
  },
];
      ...
      >
        ...
        >
          ...
          <span style={{ fontWeight: 600 }}>
            [MONTH DD, YYYY — SET AT PUBLICATION]
          </span>
        </div>
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          ...
          >
            ...
            before shipping. Orders placed on weekends or holidays roll into the
            next business day. During peak season, processing may take up to{" "}
            <span style={{ color: "#C9661A", fontWeight: 600 }}>[X]</span>{" "}
            additional days.
          </p>
          <p
            style={{
          ...
          >
            ...
            . Once an order enters fulfillment, we can no longer modify it (see
            § 05).
          </p>
        </div>
        ...
        >
          ...
          >
            Standard shipping is free on every domestic order. Expedited options
            ...
            >
              ...
              <tbody>
                {RATES.map((r) => (
                  ...
                  >
                    <td
                      style={{ padding: "16px", fontWeight: 700, fontSize: 14 }}
                    >
                      {r.method}
                    </td>
                    <td
                      style={{
                        padding: "16px",
                        fontSize: 14,
                        color: r.cost === "FREE" ? "#141414" : "#C9661A",
                      }}
                    >
                      {r.cost}
                    </td>
          ...
          >
            Estimates, not guarantees. Alaska, Hawaii, and US territories may
            add [X–X] additional days.
          </p>
        </div>
        ...
        >
          ...
          >
            We currently ship to the destinations below. Don&apos;t see your
            country? Contact us — we can often arrange it.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            >
              International orders ship Delivered Duties Paid: taxes and duties
              are collected at checkout, so there&apos;s nothing to pay the
              courier when your package arrives.
            </div>
          </div>
          <p
            style={{
          ...
          >
            International transit is typically [X–XX] business days after
            dispatch, plus customs processing.
          </p>
        </div>
        ...
        >
          ...
          >
            <p style={{ margin: 0 }}>
              We can correct an address or cancel an order only while it&apos;s
              still in processing — contact us as soon as possible.
            </p>
            <p style={{ margin: 0 }}>
              If a package is returned to us as undeliverable, we&apos;ll refund
              the order minus original outbound shipping, or re-ship it at your
              cost.
            </p>
            <p style={{ margin: 0 }}>
