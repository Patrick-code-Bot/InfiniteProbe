...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        "Every wireless thermometer before this one traded convenience for a countdown clock. This one didn't.",
      url: localePath(locale, "/why-different"),
    },
  };
}
      ...
      >
        ...
        >
          <div style={{ flex: "1 1 440px", minWidth: 300 }}>
            ...
            >
              A battery is at its weakest exactly when a cook is at its longest.
              Thermoelectric power inverts that relationship: the twelve-hour
              brisket that would drain a battery is precisely what keeps
              InfiniteProbe running. There is no worst-case cook — the worst
              case is its power source.
            </p>
            <p
              style={{
                margin: 0,
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div>
                ...
                >
                  ...
                  <span
                    style={{ color: "rgba(20,20,20,0.4)", fontWeight: 800 }}
                  >
                    ↓
                  </span>
                </div>
                <div
                  style={{
                    ...
                    borderRadius: 999,
                    background:
                      "linear-gradient(90deg, rgba(20,20,20,0.55) 0%, rgba(20,20,20,0.05) 100%)",
                  }}
                />
              </div>
              <div>
            ...
            >
              A BATTERY FADES OVER A LONG COOK. HEAT-POWERED MEANS POWERED FOR
              AS LONG AS THE COOK LASTS.
            </div>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <Link href={localePath(locale, "/specs")}>
            <button
              ...
              style={{ padding: "18px 44px", fontSize: 15 }}
            >
              FULL SPECIFICATIONS
            </button>
          </Link>
